...
export function ConfiguredModelsList({
  ...
  const getProviderIcon = (type: string) => {
    switch (type) {
      ...
      case 'google_gemini':
        return <img src="/assets/Google-gemini-icon.svg.png" alt="Gemini" style={{ width: '16px', height: '16px', objectFit: 'contain' }} />
      case 'ollama':
        return <img src="/assets/ollama.png" alt="Ollama" style={{ width: '16px', height: '16px', objectFit: 'contain' }} />
      case 'openrouter':
        return <img src="/assets/open router.png" alt="OpenRouter" style={{ width: '16px', height: '16px', objectFit: 'contain' }} />
      case 'openai_compatible':
      case 'custom':
        return <img src="/assets/LM-studio.jpeg" alt="LM Studio" style={{ width: '16px', height: '16px', objectFit: 'contain' }} />
      default:
        return (
          <svg viewBox="0 0 24 24" fill="currentColor" style={{ width: '16px', height: '16px' }}>
