...
// Removed unused imports - LayoutPreferences and ReportType no longer exported
import {
  ClickTool,
  TypeTool,
  ClearTool,
...
export class BrowserAgent {
  ...
  private async _registerTools(): Promise<void> {
    ...
    this.toolManager.register(ReportTool(this.executionContext)); // Generate HTML execution reports
